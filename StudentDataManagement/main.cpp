...
//
//  Created by Cooper Strahan on 9/25/19.
...
int main(int argc, const char * argv[]) {
    //Considering the max lenght of data entered (name) to be 15
    char data[15];
    ...
    //The following forr loop counts the total number of lines in the file.
    ...
    while(option != 6) {
        ...
        if(option == 1) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                outfile << data << "\t";
                //Inserting empty data intitially into the file
                outfile << empty << "\t";
                outfile << empty << "\t";
        ...
        //This loop is used to view and add marks to the database of a student.
            ...
            if (option == 1) {
                ...
                for (int i = 0; i < count_n; i++) {
                    ...
                    //of the data being inserted. It needs to adjust accordingly
                    //for different lengths of data.
        ...
        //This loop displays all of the details of students under the same proctor ID.
